---
title: "Analyzing Microbial Social Behavior with bsocial"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Analyzing Microbial Social Behavior with bsocial}
...
The **bsocial** package provides an S4 class and methods for analyzing microbial
...
plates <- lapply(plate_files, function(f) {
  read_csv(system.file("extdata", f, package = "bsocial"), show_col_types = FALSE)
})
